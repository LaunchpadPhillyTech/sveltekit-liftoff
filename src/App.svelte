...
<script>
  ...
  // Stores
  import { showSocialProof, calculatorVisible } from './stores/ui.js';
  ...
  onMount(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => calculatorVisible.set(false), 15000);
    }, 10000);
...
<svelte:head>
  <title>ChatFlowAI - Revolutionary AI Chatbots for Small Business</title>
  <meta name="description" content="Transform your small business with AI chatbots. Multi-platform integration, 63% conversion boost. Start your free trial today - no credit card required.">
