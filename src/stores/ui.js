...
export const showSocialProof = writable(true);
...
export const roi = derived(monthlySavings, ($monthlySavings) =>
  Math.round(($monthlySavings / 97) * 100)
);
  ...
  startUrgencyTimer() {
    ...
    function updateTimer() {
      ...
      if (timeLeft > 0) {
        ...
        urgencyTimerText.set(
          `⏰ Price increases in ${days}d ${hours}h ${minutes}m`
        );
      } else {
